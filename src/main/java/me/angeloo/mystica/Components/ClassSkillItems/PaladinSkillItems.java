...
public class PaladinSkillItems {
    ...
    public PaladinSkillItems(Mystica main, AbilityManager manager){
        weapon = new MysticaEquipment(EquipmentSlot.WEAPON, PlayerClass.Paladin, 1);
    ...
    public ItemStack getSkill(int number, Player player){
        ...
        if(subclass.equals(SubClass.Divine)){
            switch(number){
                ...
                case 1:{
                    return itemGetter.getItem(Material.YELLOW_DYE, 11,
                ...
                case 2:{
                    return itemGetter.getItem(Material.YELLOW_DYE, 12,
                ...
                case 3:{
                    return itemGetter.getItem(Material.YELLOW_DYE, 13,
                ...
                case 4:{
                    return itemGetter.getItem(Material.YELLOW_DYE, 14,
                ...
                case 5:{
                    return itemGetter.getItem(Material.YELLOW_DYE, 15,
                ...
                case 6:{
                    return itemGetter.getItem(Material.YELLOW_DYE, 16,
                ...
                case 7:{
                    return itemGetter.getItem(Material.YELLOW_DYE, 17,
                ...
                case 8:{
                    return itemGetter.getItem(Material.YELLOW_DYE, 18,
        ...
        switch(number){
            ...
            case 1:{
                return itemGetter.getItem(Material.YELLOW_DYE, 1,
            ...
            case 2:{
                return itemGetter.getItem(Material.YELLOW_DYE, 2,
            ...
            case 3:{
                return itemGetter.getItem(Material.YELLOW_DYE, 3,
            ...
            case 4:{
                return itemGetter.getItem(Material.YELLOW_DYE, 4,
            ...
            case 5:{
                return itemGetter.getItem(Material.YELLOW_DYE, 5,
            ...
            case 6:{
                return itemGetter.getItem(Material.YELLOW_DYE, 6,
            ...
            case 7:{
                return itemGetter.getItem(Material.YELLOW_DYE, 7,
            ...
            case 8:{
                return itemGetter.getItem(Material.YELLOW_DYE, 8,
    ...
    public ItemStack getUltimate(Player player){
        ...
        switch(subClass){
            case Templar:{
                return itemGetter.getItem(Material.YELLOW_DYE, 9,
            ...
            case Divine:{
                return itemGetter.getItem(Material.YELLOW_DYE, 19,
            ...
            case Dawn:{
                return itemGetter.getItem(Material.YELLOW_DYE, 10,

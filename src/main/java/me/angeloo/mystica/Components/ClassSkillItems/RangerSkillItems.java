...
public class RangerSkillItems {
    ...
    public ItemStack getSkill(int number, Player player){
        ...
        switch(number){
            ...
            case 1:{
                return getItem(Material.BEETROOT_SEEDS, 0,
            ...
            case 2:{
                return getItem(Material.BLACK_DYE, 0,
            ...
            case 4:{
                return getItem(Material.FLINT, 0,
            ...
            case 5:{
                return getItem(Material.SPECTRAL_ARROW, 0,
            ...
            case 6:{
                return getItem(Material.DRIED_KELP, 0,
            ...
            case 7:{
                return getItem(Material.SADDLE, 0,
            ...
            case 8:{
                return getItem(Material.SUGAR, 0,

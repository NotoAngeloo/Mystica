        ...
        switch(number){
            ...
            case 2:{
                return getItem(2,
                        ...
                        ChatColor.of(Color.BLUE) + String.valueOf(abilityManager.getRangerAbilities().getShadowCrows().getCost()) + " mana",
                        "",
            ...
            case 3:{
                return getItem(3,
                        ...
                        ChatColor.of(Color.BLUE) + String.valueOf(abilityManager.getRangerAbilities().getRelentless().getCost()) + " mana",
                        "",
            ...
            case 4:{
                return getItem(4,
                        ...
                        ChatColor.of(Color.BLUE) + String.valueOf(abilityManager.getRangerAbilities().getRazorWind().getCost()) + " mana",
                        "",
            ...
            case 5:{
                return getItem(5,
                        ...
                        ChatColor.of(Color.BLUE) + String.valueOf(abilityManager.getRangerAbilities().getBlessedArrow().getCost()) + " mana",
                        "",
            ...
            case 6:{
                return getItem(6,
                        ...
                        ChatColor.of(Color.BLUE) + String.valueOf(abilityManager.getRangerAbilities().getRallyingCry().getCost()) + " mana",
                        "",
            ...
            case 7:{
                return getItem(7,
                        ...
                        ChatColor.of(Color.BLUE) + String.valueOf(abilityManager.getRangerAbilities().getWildSpirit().getCost()) + " mana",
                        "",
            ...
            case 8:{
                return getItem(8,
                        ...
                        ChatColor.of(Color.BLUE) + String.valueOf(abilityManager.getRangerAbilities().getRoll().getCost()) + " mana",
                        "",
        ...
        switch(subClass.toLowerCase()){
            case "scout":{
                return getItem(9,
                        ...
                        ChatColor.of(Color.BLUE) + String.valueOf(abilityManager.getRangerAbilities().getStarVolley().getCost()) + " mana",
                        "",
            ...
            case "animal tamer":{
                return getItem(10,
                        ...
                        ChatColor.of(Color.BLUE) + String.valueOf(abilityManager.getRangerAbilities().getWildRoar().getCost()) + " mana",
                        "",

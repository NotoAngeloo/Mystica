        ...
        switch(number){
            ...
            case 6:{
                return getItem(6,
                        ...
                        ChatColor.of(Color.BLUE) + String.valueOf(abilityManager.getRangerAbilities().getRallyingCry()) + " mana",
                        "",
            ...
            case 8:{
                return getItem(8,
                        ...
                        ChatColor.of(Color.BLUE) + String.valueOf(abilityManager.getRangerAbilities().getRoll()) + " mana",
                        "",
        ...
        switch(subClass.toLowerCase()){
            ...
            case "animal tamer":{
                return getItem(10,
                        ...
                        ChatColor.of(Color.BLUE) + String.valueOf(abilityManager.getRangerAbilities().getWildRoar()) + " mana",
                        "",

...
public class CaptainNpc {

    private final Mystica main;
    private final ProfileManager profileManager;

    public CaptainNpc(Mystica main, ProfileManager profileManager){
        this.main = main;
    ...
    public void spawn() throws InvalidMobTypeException {
        ...
        Location spawnLoc = new Location(world, -18.5, 84, -185, 180, 0);
            ...
            public void run(){
                ...
                for(Entity entity : world.getNearbyEntities(hitBox)){
                    if(entity instanceof Player){
                        try {
                            MythicBukkit.inst().getAPIHelper().spawnMythicMob("CaptainNpc", spawnLoc);

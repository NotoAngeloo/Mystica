...
public class Wings {
    ...
    public Wings(Mystica main, ProfileManager profileManager, MysticaPartyManager mysticaPartyManager){
    ...
    public void makeProfile(UUID uuid){
        ...
        FakePlayerProfile fakePlayerProfile = new FakePlayerProfile(false, false, stats, PlayerClass.Mystic, SubClass.Shepard);

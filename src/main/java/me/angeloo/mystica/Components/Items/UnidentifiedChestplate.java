...
public class UnidentifiedChestplate{

    private final ItemManager manager;

    public UnidentifiedChestplate(ItemManager manager){
        this.manager = manager;
    }


    public ItemStack getUnidentifiedT1Chestplate(int level){

        return manager.getItem(Material.IRON_INGOT, 1,
                ChatColor.of(commonColor) + "Unidentified Chestplate",
    ...
    public ItemStack getUnidentifiedT2Chestplate(int level){

        return manager.getItem(Material.IRON_INGOT, 1,
                ChatColor.of(uncommonColor) + "Unidentified Chestplate",

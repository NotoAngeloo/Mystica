...
public class UnidentifiedHelmet extends ItemStack {

    public UnidentifiedHelmet(int level){
        super(Material.IRON_INGOT);
        ItemMeta meta = this.getItemMeta();
        assert meta != null;
        meta.setDisplayName(ChatColor.of(new Color(218, 133, 36)) + "Unidentified Helmet");

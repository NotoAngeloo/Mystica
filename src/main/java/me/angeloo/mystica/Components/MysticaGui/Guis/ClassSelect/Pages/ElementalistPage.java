...
public class ElementalistPage extends GuiPage {
    ...
    protected void build(
        ...
        List<String> description = PlayerClass.ELEMENTALIST.getDescription();
        context.drawTextContainer(-105, -16, description);
        /*
         * Decorative buttons
         */

        context.drawIcon(6, -108, UiGlyphs.SHADOW_KNIGHT_ICON);

        context.drawIcon(6, -54, UiGlyphs.WARRIOR_ICON);

        context.drawIcon(6, 0, UiGlyphs.ASSASSIN_ICON);

        context.drawIcon(6, 54, UiGlyphs.BUTTON_3x3);

        context.drawIcon(6, 126, UiGlyphs.MYSTIC_ICON);

        context.drawIcon(6, 180, UiGlyphs.PALADIN_ICON);

        context.drawIcon(6, 234, UiGlyphs.RANGER_ICON);

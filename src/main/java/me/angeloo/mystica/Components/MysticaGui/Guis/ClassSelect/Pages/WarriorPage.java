...
public class WarriorPage extends GuiPage {
    ...
    protected void build(
        ...
        List<String> description = PlayerClass.WARRIOR.getDescription();
        ...
        context.drawIcon(6, -108, UiGlyphs.PALADIN_ICON);

        context.drawIcon(6, -54, UiGlyphs.RANGER_ICON);

        context.drawIcon(6, 0, UiGlyphs.SHADOW_KNIGHT_ICON);

        context.drawIcon(6, 54, UiGlyphs.BUTTON_3x3);

        context.drawIcon(6, 126, UiGlyphs.ASSASSIN_ICON);

        context.drawIcon(6, 180, UiGlyphs.ELEMENTALIST_ICON);

        context.drawIcon(6, 234, UiGlyphs.MYSTIC_ICON);
        ...
        button(
                ...
                new GuiButton() {
                    ...
                    public Glyph glyph() {
                        ...
                        return UiGlyphs.GLADIATOR_ICON_2;
                    }
        ...
        button(
                ...
                new GuiButton() {
                    ...
                    public Glyph glyph() {
                        ...
                        return UiGlyphs.EXECUTIONER_ICON_2;
                    }

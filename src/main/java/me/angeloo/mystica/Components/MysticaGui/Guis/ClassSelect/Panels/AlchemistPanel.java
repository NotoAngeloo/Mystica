...
public class AlchemistPanel extends GuiPanel {

    private final ClassSelect gui;

    public AlchemistPanel(ClassSelect gui){
        this.gui = gui;
    }
    ...
    public boolean isVisible(Player player){
        ...
        return gui.getSelectedSubclass().equals(SubClass.ALCHEMIST);
    }
    ...
    private void drawContent(GuiRenderContext context){
        ...
        context.drawDescriptionCard(
                ...
                ConstructedIcons.ALCHEMIST_ICON,

                List.of(
                        SubClass.ALCHEMIST.getDisplayName(),
                        SubClass.ALCHEMIST.getRange().getDisplayName()
                                + " " +SubClass.ALCHEMIST.getRole().getDisplayName(),
                        SubClass.ALCHEMIST.getDamageType().getDisplayName()
                ),

                SubClass.ALCHEMIST.getDescription(),

...
public class ConjurerPanel extends GuiPanel {

    private final ClassSelect gui;

    public ConjurerPanel(ClassSelect gui){
        this.gui = gui;
    }
    ...
    public boolean isVisible(Player player){
        ...
        return gui.getSelectedSubclass().equals(SubClass.CONJURER);
    }
    ...
    private void drawContent(GuiRenderContext context){
        ...
        context.drawDescriptionCard(
                ...
                ConstructedIcons.CONJURER_ICON,

                List.of(
                        SubClass.CONJURER.getDisplayName(),
                        SubClass.CONJURER.getRange().getDisplayName()
                                + " " +SubClass.CONJURER.getRole().getDisplayName(),
                        SubClass.CONJURER.getDamageType().getDisplayName()
                ),

                SubClass.CONJURER.getDescription(),

...
public class PyromancerPanel extends GuiPanel {

    private final ClassSelect gui;

    public PyromancerPanel(ClassSelect gui){
        this.gui = gui;
    }
    ...
    public boolean isVisible(Player player){
        ...
        return gui.getSelectedSubclass().equals(SubClass.PYROMANCER);
    }
    ...
    private void drawContent(GuiRenderContext context){
        ...
        context.drawDescriptionCard(
                ...
                ConstructedIcons.PYROMANCER_ICON,

                List.of(
                        SubClass.PYROMANCER.getDisplayName(),
                        SubClass.PYROMANCER.getRange().getDisplayName()
                                + " " +SubClass.PYROMANCER.getRole().getDisplayName(),
                        SubClass.PYROMANCER.getDamageType().getDisplayName()
                ),

                SubClass.PYROMANCER.getDescription(),

                new CardStyle(
                        PlayerClass.ELEMENTALIST.getColor(),
                        Color.BLACK,

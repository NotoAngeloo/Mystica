...
public class ShepardPanel extends GuiPanel {

    private final ClassSelect gui;

    public ShepardPanel(ClassSelect gui){
        this.gui = gui;
    }
    ...
    public boolean isVisible(Player player){
        ...
        return gui.getSelectedSubclass().equals(SubClass.SHEPARD);
    }
    ...
    private void drawContent(GuiRenderContext context){
        ...
        context.drawDescriptionCard(
                ...
                ConstructedIcons.SHEPARD_ICON,

                List.of(
                        SubClass.SHEPARD.getDisplayName(),
                        SubClass.SHEPARD.getRange().getDisplayName()
                                + " " +SubClass.SHEPARD.getRole().getDisplayName(),
                        SubClass.SHEPARD.getDamageType().getDisplayName()
                ),

                SubClass.SHEPARD.getDescription(),

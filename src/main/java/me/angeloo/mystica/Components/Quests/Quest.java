...
public class Quest {
    ...
    public Quest(String id, String name, List<String> description, List<String> progress, List<String> completed,List<QuestObjective> objectives, List<QuestReward> rewards) {
        this.id = id;
        this.name = name;

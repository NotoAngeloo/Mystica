...
public class GeneralEventListener implements Listener {
    ...
    public void whenHealthChanged(HealthChangeEvent event) {
        ...
        Bukkit.getServer().getPluginManager().callEvent(new HudUpdateEvent(defender, SelfInfo));
        ...
        if (!(defender instanceof Player)) {
            ...
            if (!profileManager.getAnyProfile(defender).fakePlayer()) {
                ...
                if (bossManager.getIfResetProcessing(defender)) {
                    return;
                }
        ...
        if (defender instanceof Player || profileManager.getAnyProfile(defender).fakePlayer()) {
            ...
            if(defender instanceof Player dPlayer) {
    ...
    public void hudUpdate(HudUpdateEvent event) {
        ...
        if(barType.equals(SelfInfo)){
            hudManager.updateEntityBarInformation(entity);
            return;
        }
